...
class FacetDtoTest extends TestCase
{
    ...
    public function testGetValuesThrowsExceptionOnWrongType()
    {
        $data = [
            'field_name' => 'properties.Farbe',
            'stats' => [],
    ...
    public function testGetMinThrowsExceptionOnWrongType()
    {
        $data = [
            'field_name' => 'properties.Farbe',
            'stats' => [],
    ...
    public function testGetSelectedMinThrowsExceptionOnWrongType()
    {
        $data = [
            'field_name' => 'properties.Farbe',
            'stats' => [],
        ...
        $this->expectException(\InvalidArgumentException::class);
        $facetDto->getSelectedMin();
    }

    public function testGetMaxThrowsExceptionOnWrongType()
    {
        $data = [
            'field_name' => 'properties.Farbe',
            'stats' => [],
    ...
    public function testGetSelectedMaxThrowsExceptionOnWrongType()
    {
        $data = [
            'field_name' => 'properties.Farbe',
            'stats' => [],
